...
const Toaster = ({ ...props }: ToasterProps) => {
  return (
    <Sonner
      theme="dark"
      position="top-center"
      className="toaster group !mt-[env(safe-area-inset-top,-14px)]"
      icons={{
      ...
      toastOptions={{
        classNames: {
          toast:
            "!backdrop-blur-2xl !text-white  !shadow-[inset_0_1px_1px_rgba(255,255,255,0.35),0_16px_36px_-6px_rgba(0,0,0,0.85)] font-sans !rounded-lg !px-4 !py-2.5",
          title: "!text-white !font-bold !text-xs",
          description: "!text-white/60 !font-medium !text-[11px]",
          actionButton:
            "!bg-white/15 hover:!bg-white/25 !text-white !font-bold !px-3 !py-1 !rounded-lg !text-xs transition-colors",
          cancelButton:
            "!bg-transparent !text-white/50 hover:!text-white !rounded-xl !text-xs",
