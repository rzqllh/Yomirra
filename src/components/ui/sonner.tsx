    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            "group-[.toast]:bg-accent group-[.toast]:text-text-on-accent font-bold px-4 py-1.5 rounded-xl hover:bg-accent-hover transition-colors",
          cancelButton:
            "group-[.toast]:bg-surface-muted group-[.toast]:text-text-muted rounded-xl",
