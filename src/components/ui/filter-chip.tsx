  ...
  ({ variant = "default", label, showCheck, showMinus, showDownBadge, selected, className, "aria-label": ariaLabel, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "min-h-11 px-3.5 rounded-[12px] text-xs font-bold transition-all border flex items-center justify-center gap-1.5 active:scale-[0.98] shrink-0",
          ...
          variant === "accent-solid" && "bg-accent text-accent-on border-transparent shadow-xs",
          variant === "error-solid" && "bg-status-error-bg text-status-error-fg border-status-error-fg",
