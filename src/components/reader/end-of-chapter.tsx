...
export function EndOfChapter({
  ...
  return (
    <div className="w-full max-w-[600px] mx-auto px-4 py-12 pb-[calc(3rem+env(safe-area-inset-bottom))] flex flex-col items-center justify-center animate-in fade-in slide-in-from-bottom-8 duration-500">
